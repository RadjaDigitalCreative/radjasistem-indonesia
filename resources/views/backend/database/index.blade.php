  ...
  <div class="col-md-12">
    <div class="card">
      ...
      <div class="card-header">
        ...
        <a href="{{route('database.deleteAll')}}"><button type="button" class="btn btn-danger"><i class="now-ui-icons ui-1_simple-remove"></i> Hapus Semua</button></a>
      </div>
      ...
      <table id="table_id" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td align="center">
              <form id="data-{{ $row->id }}" action="{{route('database.delete',$row->id)}}" method="post">
                {{csrf_field()}}
                {{method_field('delete')}}
              </form>
              @csrf
