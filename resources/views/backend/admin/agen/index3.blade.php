  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Member Agen Biasa</h4>
      ...
      <div class="card-body">
        ...
        @if($links->agen == 3 && $links->referal3 == auth()->user()->referal3)
            ...
            <div class="card-header" id="headingTwo">
              <h2 class="mb-0">
                <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#modal-show{{$links->id}}" aria-expanded="false" aria-controls="collapseTwo">
                  ...
                  <h6 style="font-size: 18px; float: right;">#{{$links->referal3}}</h6>
                </button>
              </h2>
            </div>
              ...
              <div class="card-body">
                <table  class="table table-striped table-bordered" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    ...
                    @if ($links->referal3 == $row->referal3 && $row->agen == 4)
                    <tr>
                     <td>{{$nomor++}}</td>
                     <td>{{$row->name}}</td>
                     <td>
