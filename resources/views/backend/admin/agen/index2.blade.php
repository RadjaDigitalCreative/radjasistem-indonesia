  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Member Super Agen</h4>
      ...
      <div class="card-body">
        ...
        @if($links->agen == 2 && $links->referal2 == auth()->user()->referal2)
            ...
            <div class="card-header" id="headingTwo">
              <h2 class="mb-0">
                <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#modal-show{{$links->id}}" aria-expanded="false" aria-controls="collapseTwo">
                  ...
                  <h6 style="font-size: 18px; float: right;">#{{$links->referal2}}</h6>
                </button>
              </h2>
            </div>
              ...
              <div class="card-body">
                <table  class="table table-striped table-bordered" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    ...
                    @if ($links->referal2 == $row->referal2 && $row->agen == 3)
                    <tr>
                     <td>{{$nomor++}}</td>
                     <td>{{$row->name}}</td>
                     <td>
                     ...
                     @if ($row->referal3 == NULL)
                    <td><a href="{{ route('agen.ketiga', $row->id)}}" class="btn btn-success"><i class="now-ui-icons business_money-coins"></i> Create Agen Ketiga</a></td>
                    @else
                    <td>{{$row->referal3}}</td>
                    @endif
      ...
      @elseif($links->agen == 2 && auth()->user()->id_team == 1)
      <div class="accordion" id="accordionExample-{{$links->id}}">
        <div class="card">
          <div class="card-header" id="headingTwo">
            <h2 class="mb-0">
