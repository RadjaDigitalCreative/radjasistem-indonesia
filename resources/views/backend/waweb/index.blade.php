  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        ...
        <div  class="btn-group">
         <a href="{{route('waweb.create')}}"><button type="button" class="btn btn-success"><i class="now-ui-icons ui-1_simple-add"></i> Tambah</button></a>
        ...
        <a href="{{route('wa.delete')}}"><button type="button" class="btn btn-danger"><i class="now-ui-icons ui-1_simple-remove"></i> Hapus Semua</button></a>
      </div>
