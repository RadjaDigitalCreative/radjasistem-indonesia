            ...
            <form class="form" action="{{route('register')}}" method="post">
              ...
              <div class="card-body">
                ...
                <div class="input-group form-group-no-border input-lg">
                  ...
                  <input id="referal" readonly="" value="{{$data2->referal2}}" type="text" name="referal" class="form-control" placeholder="Masukkan Code Referal..." data-toggle="popover" title="Kode Referal" data-content="Code Referal Anda Sudah Terpasang Silahkan Lanjutkan!!">
                </div>
