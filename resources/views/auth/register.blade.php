            ...
            <form class="form" action="{{route('register')}}" method="post">
              ...
              <div class="card-body">
                ...
                <div class="input-group form-group-no-border input-lg">
                  ...
                  <input id="referal" type="text" name="referal" class="form-control" placeholder="Masukkan Code Referal..." data-toggle="popover" title="Kode Referal" data-content="Jika anda memiliki kode referal dan mendapatkan informasi aplikasi dari orang lain, silahkan masukkan. Jadilah salah satu dari kami!!">
                </div>
